...
const updateSeminarById = async (req, res) => {
  try {
    ...
    const seminarNeedsToUpdate = await seminarService.getSeminarsById(req.params.id);
    ...
    const seminar = new seminarValidation(req);
    const updatedseminar = await seminarService.updateSeminarById(req.params.id, seminar);
