...
const ArticleList = () => {
  ...
  const retrieveArticles = async () => {
    axios
      .get(`https://ecohub-backend.onrender.com/articles/get/all`)
      .then((res) => {
  ...
  const onDelete = (id) => {
    axios
      .delete(`https://ecohub-backend.onrender.com/articles/delete/${id}`)
      .then(() => {
  ...
  const searchArticles = () => {
    setArticles([]);
    axios
      .post("https://ecohub-backend.onrender.com/articles/search", {
